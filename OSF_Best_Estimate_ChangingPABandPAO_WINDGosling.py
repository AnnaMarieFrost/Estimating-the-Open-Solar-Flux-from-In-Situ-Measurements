...
def FilterWINDLow(start_date, end_date):
        ...
        nc = xr.open_dataset('WIND-L Corrected Time Bow Shock Correction Solar Maximum One Year.nc')
...
start_date = datetime.date(1998,1,22)
end_date = datetime.date(2017,12,31)
Br, timestamp, BGflux, FluxStrTemp, FluxAnStrTemp, total_data = BodyWIND(start_date, end_date)
...
"""
np.savetxt('TopologyTextFiles/N_AS_Wind_Gosling.txt', N_AS)   
np.savetxt('TopologyTextFiles/N_SS_Wind_Gosling.txt', N_SS)
np.savetxt('TopologyTextFiles/N_CL_Wind_Gosling.txt', N_CL)   
np.savetxt('TopologyTextFiles/N_U_Wind_Gosling.txt', N_U)   
np.savetxt('TopologyTextFiles/OSF_Wind_Gosling.txt', OSF) 
  
np.savetxt('TopologyTextFiles/opposite_Wind_Gosling.txt', opposite)   
np.savetxt('TopologyTextFiles/bgboundary_Wind_Gosling.txt', bgboundary)
