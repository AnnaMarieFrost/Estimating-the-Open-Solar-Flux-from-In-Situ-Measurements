...
###############################################################################
"""
Using the same time period as Pagel, Crooker, and Larson (2005).
"""
###############################################################################
...
"""
np.savetxt('TopologyTextFiles/N_AS_Wind_Pagel.txt', N_AS)   
np.savetxt('TopologyTextFiles/N_SS_Wind_Pagel.txt', N_SS)
np.savetxt('TopologyTextFiles/N_CL_Wind_Pagel.txt', N_CL)   
np.savetxt('TopologyTextFiles/N_U_Wind_Pagel.txt', N_U)   
np.savetxt('TopologyTextFiles/OSF_Wind_Pagel.txt', OSF) 
  
np.savetxt('TopologyTextFiles/opposite_Wind_Pagel.txt', opposite)   
np.savetxt('TopologyTextFiles/bgboundary_Wind_Pagel.txt', bgboundary)
