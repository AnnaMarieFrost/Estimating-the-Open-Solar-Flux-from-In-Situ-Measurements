...
###############################################################################
"""
Using the same time period as Skoug et al. (2000).
"""
###############################################################################

start_date = datetime.date(1998,2,3)
end_date = datetime.date(1998,10,27)
...
"""
np.savetxt('TopologyTextFiles/N_AS_ACE_Skoug.txt', N_AS)   
np.savetxt('TopologyTextFiles/N_SS_ACE_Skoug.txt', N_SS)
np.savetxt('TopologyTextFiles/N_CL_ACE_Skoug.txt', N_CL)   
np.savetxt('TopologyTextFiles/N_U_ACE_Skoug.txt', N_U)   
np.savetxt('TopologyTextFiles/OSF_ACE_Skoug.txt', OSF) 
  
np.savetxt('TopologyTextFiles/opposite_ACE_Skoug.txt', opposite)   
np.savetxt('TopologyTextFiles/bgboundary_ACE_Skoug.txt', bgboundary)
